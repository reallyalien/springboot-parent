...
//        streamOperator2.print("stream2");
    ...
    public void connect() {
        ...
        streams.process(new CoProcessFunction<Integer, Long, Object>() {
            @Override
    ...
    public void onGroup() {
        ...
        DataStream<Object> apply = stream1.coGroup(stream2)
                .where(r -> r.f0)
                .equalTo(r -> r.f0)
                .window(TumblingEventTimeWindows.of(Time.seconds(100000)))
                .apply(new CoGroupFunction<Tuple2<String, Long>, Tuple2<String, Long>, Object>() {
                    @Override
                    public void coGroup(Iterable<Tuple2<String, Long>> first, Iterable<Tuple2<String, Long>> second, Collector<Object> out) throws Exception {
    ...
    public void unionTest1() {
        ...
        DataStreamSource<Tuple2<String, Long>> source2 = env.fromElements(
                Tuple2.of("a1", 3000L),
                Tuple2.of("b1", 3000L),
                Tuple2.of("a1", 4000L),
                Tuple2.of("b1", 4000L)
        );
        DataStream<Tuple2<String, Long>> union = source1.union(source2);
        union.print("---->>");
