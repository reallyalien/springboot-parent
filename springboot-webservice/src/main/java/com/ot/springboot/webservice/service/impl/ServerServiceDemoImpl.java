package com.ot.springboot.webservice.service.impl;

import com.ot.springboot.webservice.service.ServerServiceDemo;
...
@Component
@WebService(
        name = "ServerServiceDemo",
        targetNamespace = "http://server.webservice.example.com",
        endpointInterface = "com.ot.springboot.webservice.service.ServerServiceDemo"
)
