...
public class ProduceText {
    ...
    //topic
//    private static final String topicName = "text_topic";
    private static final String topicName = "new_add_text_topic";
    ...
    public static void main(String[] args) {
        ...
        try {
            //同步发送
            for (int i = 10; i <= 20; i++) {
                ProducerRecord<String, String> record = new ProducerRecord<>(topicName, "这是一段普通的文本" + i);
