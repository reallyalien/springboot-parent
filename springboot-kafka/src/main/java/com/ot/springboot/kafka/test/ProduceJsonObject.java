 ...
 */
@Slf4j
public class ProduceJsonObject {
    //kafka集群地址
    private static final String brokerList = "192.168.2.111:6667";
    //topic
    private static final String topicName = "json_object_topic";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 1; i <= 10; i++) {
                ...
                map.put("id", i);
                map.put("name", i + "这是json格式的数据");
                ProducerRecord<String, Object> record = new ProducerRecord<>(topicName, map);
