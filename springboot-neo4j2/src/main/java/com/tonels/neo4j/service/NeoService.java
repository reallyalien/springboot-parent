package com.tonels.neo4j.service;
...
import com.tonels.neo4j.payload.ClassmateInfoGroupByLesson;
import com.tonels.neo4j.payload.TeacherStudent;
import com.tonels.neo4j.repository.LessonRepository;
import com.tonels.neo4j.repository.StudentRepository;
import com.tonels.neo4j.model.Class;
...
public class NeoService {
    ...
    public List<Student> findByClass(String className,int depth){
        return studentRepo.findAllByClazzName(className,depth);
    }
}
